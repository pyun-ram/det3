...
def check_datadir_valid(data_dir):
    ...
    assert os.path.exists(os.path.join(data_dir, "velo_side_left"))
    assert os.path.exists(os.path.join(data_dir, "velo_side_right"))
    assert os.path.exists(os.path.join(data_dir, "velo_front"))
    assert os.path.exists(os.path.join(data_dir, "velo_rear"))
    assert len(os.listdir(os.path.join(data_dir, "calib"))) == \
        ...
        len(os.listdir(os.path.join(data_dir, "velo_side_left"))) == \
        len(os.listdir(os.path.join(data_dir, "velo_side_right"))) == \
        len(os.listdir(os.path.join(data_dir, "velo_front"))) == \
        len(os.listdir(os.path.join(data_dir, "velo_rear")))
...
def split_data(data_dir, idx_path, output_dir):
    ...
    os.mkdir(os.path.join(output_dir, 'velo_side_left'))
    os.mkdir(os.path.join(output_dir, 'velo_side_right'))
    os.mkdir(os.path.join(output_dir, 'velo_front'))
    os.mkdir(os.path.join(output_dir, 'velo_rear'))
    ...
    for idx in idx_list:
        ...
        os.symlink(os.path.join(data_dir, 'velo_side_left', idx + '.npy'), os.path.join(output_dir, 'velo_side_left', idx + '.npy'))
        os.symlink(os.path.join(data_dir, 'velo_side_right', idx + '.npy'), os.path.join(output_dir, 'velo_side_right', idx + '.npy'))
        os.symlink(os.path.join(data_dir, 'velo_front', idx + '.npy'), os.path.join(output_dir, 'velo_front', idx + '.npy'))
        os.symlink(os.path.join(data_dir, 'velo_rear', idx + '.npy'), os.path.join(output_dir, 'velo_rear', idx + '.npy'))
    return len(idx_list)
...
def validate(output_dir, num_data):
    ...
    assert num_data == len(os.listdir(os.path.join(output_dir, "velo_side_left")))
    assert num_data == len(os.listdir(os.path.join(output_dir, "velo_side_right")))
    assert num_data == len(os.listdir(os.path.join(output_dir, "velo_front")))
    assert num_data == len(os.listdir(os.path.join(output_dir, "velo_rear")))
